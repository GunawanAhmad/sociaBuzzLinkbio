...
function checkInput(e) {
  if (e.value != "") {
    ...
    e.style.fontSize = "0.833rem";
      ...
      {"./circleLinkHandler.js":1,"./inputFormHandler.js":2,"./rearrangeHandler.js":3,"../globalHandler/previewHandler.js":4,"../linkPage/thumbnailHandler.js":5},
    ],1: [
      function (require, module, exports) {
        "use strict";
...
function CircleLinkObj(active, title, imgSrc, link, elm, index) {
  ...
  this.deleteBtn.addEventListener("click", function () {
    (0, _deleteHandler.deleteHandler)(_this.elm, "circle", _this, updateCircleLinkElm, toggleTitleAndIcon);
  });
}
...
function inputFormHandler() {
  ...
  function addNewInput(type) {
    var isNewElm = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    switch (type) {
      ...
      case "donasi":
        ...
        break;
      case "produk-digital":
        HTMLString = (0, _inputFormHTMLSource.produkDigitalInputLink)(produkDigitalInputLinkCount);
...
function searchIcons() {
  ...
  for (var i = 0; i < icons.length; i++) {
    $(icons[i]).parent().click(function (e) {
