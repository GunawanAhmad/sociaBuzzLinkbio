(function (modules) {
    ...
    1: [
        function (require, module, exports) {
            ...
            var circleModalImg = document.getElementById(
                "circle-link-modal-img"
            );
            var circelModalTitle = document.getElementById(
                "circle-link-title-input"
            );
            var circelModalLink = document.getElementById(
                "circle-link-link-input"
            );
            var circleTitleLength = document.querySelector(
                ".circle-title-length"
            );
            var MAX_LENGTH = 9;
            var currentLength = 0;
            ...
            function circleLinkHandler() {
                ...
                cirlceLinkList.forEach(function (element, index) {
                    element.addEventListener("click", function () {
                        ...
                        circelModalTitle.value =
                            selectedCirlceLink.querySelector(
                                ".cirlce-link-title"
                            ).innerText;
                        currentLength = circelModalTitle.value.length;
                        circleTitleLength.textContent =
                ...
                document
                    ...
                    .addEventListener("click", function () {
                        ...
                        selectedCirlceLink.setAttribute(
                            "data-link",
                            circelModalLink.value
                        );
                    });
            ...
            function getAllCircleValue() {
                cirlceLinkList.forEach(function (elm, idx) {
                    var img = elm
                        ...
                        .getAttribute("src");
                    var title =
                        elm.querySelector(".cirlce-link-title").innerHTML;
                    var link = elm.getAttribute("data-link");
                    var active = elm.querySelector(
                        "input[type='checkbox']"
                    ).checked;
    ...
    2: [
        function (require, module, exports) {
            ...
            function inputForm(elm) {
                ...
                var selectInputFormForDelete =
                    function selectInputFormForDelete() {
                        (0, _deleteHandler.deleteHandler)(
                            containerElm,
                            "form-link"
                        );
                    };
            ...
            function inputFormHandler() {
                ...
                function addNewInput(type) {
                    ...
                    switch (type) {
                        case "regular":
                            HTMLString = (0,
                            _inputFormHTMLSource.regularInputLink)(
                        ...
                        case "header":
                            HTMLString = (0,
                            _inputFormHTMLSource.headerInputLink)(
                        ...
                        case "donasi":
                            HTMLString = (0,
                            _inputFormHTMLSource.donasiInputLink)(
                        ...
                        case "digital-akses":
                            HTMLString = (0,
                            _inputFormHTMLSource.digitalAksesInputLink)(
                        ...
                        case "konten":
                            HTMLString = (0,
                            _inputFormHTMLSource.kontenInputLink)(
                        ...
                        case "paket-jasa":
                            HTMLString = (0,
                            _inputFormHTMLSource.paketJasaInputLink)(
                        ...
                        case "kerjasama":
                            HTMLString = (0,
                            _inputFormHTMLSource.kerjasamaInputLink)(
                        ...
                        case "embed":
                            HTMLString = (0,
                            _inputFormHTMLSource.embedInputLink)(
                                embedInputLinkCount
                            );
                            embedInputLinkCount++;
                            break;
                        case "whatsapp":
                            HTMLString = (0,
                            _inputFormHTMLSource.whatsappInputLink)(
                        ...
                        case "email":
                            HTMLString = (0,
                            _inputFormHTMLSource.emailInputLink)(
                                emailInputLinkCount
                            );
                            emailInputLinkCount++;
                            break;
                        case "email-collection":
                            HTMLString = (0,
                            _inputFormHTMLSource.emailColletionInputLink)(
                        ...
                        case "video-request":
                            HTMLString = (0,
                            _inputFormHTMLSource.videoRequestInputLink)(
                    ...
                    formLinkWrapper.insertBefore(
                        HTMLElm,
                        formLinkWrapper.firstChild
                    );
    ...
    5: [
        function (require, module, exports) {
            ...
            function deleteHandler(elm, inputType, obj, cb) {
                var deleteConfirmation = document.querySelector(
                    "#confirm-delete-btn"
                );
                var cancelDeleteBtn =
